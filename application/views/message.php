...
<div class="container page">
	<div class="row">
		<div class="col-md-3 col-sm-12 history" style="margin-top: 72px;">
			<p><a href="#">History</a></p><hr />
			<p><a href="#">Aim and Objectives</a></p><hr />
			<p><a href="#"style="color: red;">Message of The Chairman</a></p><hr />
		...
		<div class="col-md-3 col-sm-12 chsc">
			<div class="ch-img">
				<img src="<?php echo base_url();?>assets/frontend/images/t.jpg" class="img-circle" alt="" />
				<b>A.F.M Sarwar Kamal</b><hr />
				<p>Chairman BUBT Trusty</p>
			</div>
		</div>
		<div class="col-md-6 col-sm-12 ch-msg">
			<h5>Message of the Chairman</h5><hr />
