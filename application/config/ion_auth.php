 ...
 */
$config['site_title']                 = "bubt.ac.bd";       // Site Title, example.com
$config['admin_email']                = "info@devszone.com"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 20;                 // The number of seconds to lockout an account due to exceeded attempts
