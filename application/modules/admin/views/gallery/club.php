...
<div id="page-wrapper">
    ...
    <form id="campus_update" method="POST" action="<?php echo site_url('admin/gallery/update_club_details'); ?>" enctype="multipart/form-data">
        <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/gallery/club_post_ajax_list') ?>",
                "type": "POST"
            },
    ...
    function edit_slide(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/gallery/club_post_ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/gallery/club_post_ajax_add') ?>";
        } else {

            url = "<?php echo site_url('admin/gallery/club_post_ajax_update') ?>";
        }
    ...
    function delete_slide(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/gallery/club_post_ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
        ...
        if (list_id.length > 0)
        {
            if (confirm('Are you sure delete this ' + list_id.length + ' data?'))
            {
                $.ajax({
                    ...
                    url: "<?php echo site_url('admin/gallery/club_post_bulk_delete') ?>",
                    dataType: "JSON",
                    success: function (data)
                    {
                        if (data.status)
