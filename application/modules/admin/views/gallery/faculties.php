...
<div id="page-wrapper">
    ...
    <form id="campus_update" method="POST" action="<?php echo site_url('admin/gallery/update_faculty_video'); ?>" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel panel-default panel-table">
                    ...
                    <div class="panel-body">
                        <textarea class="form-control" name="video_url"><?php echo $faculties[0]['video_url']; ?></textarea> 
                    </div>

                </div>
            </div>
            <div class="col-md-3">
                <input type="hidden" name="gallery_id" value="<?php echo $faculties[0]['gallery_id']; ?>" />
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/gallery/faculty_post_ajax_list') ?>",
                "type": "POST"
            },
    ...
    function edit_slide(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/gallery/faculty_post_ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/gallery/faculty_post_ajax_add') ?>";
        } else {

            url = "<?php echo site_url('admin/gallery/faculty_post_ajax_update') ?>";
        }
    ...
    function delete_slide(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/gallery/faculty_post_ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
