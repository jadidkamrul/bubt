...
<div id="page-wrapper">
    ...
    <form id="" method="POST" action="<?php echo site_url('admin/gallery/update_location'); ?>" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default panel-table">
                    ...
                    <div class="panel-body">
                        <textarea class="form-control" name="content_left"><?php echo $location[0]['content_left']; ?></textarea> 
                    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default panel-table">
                    ...
                    <div class="panel-body">
                        <textarea id="txtEditor1" name="content_right"><?php echo $location[0]['content_right']; ?></textarea> 
                    </div>

                </div>
            </div>
            <div class="col-md-3">
                <input type="hidden" name="gallery_id" value="<?php echo $location[0]['gallery_id']; ?>" />
                <input type="submit" class="btn btn-default " name="logo_update" value="Update"> 
                ...
                <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="student_photo_preview "> 
                            <img width="50" id="previewHolder" src="" alt="Student Photo" />
