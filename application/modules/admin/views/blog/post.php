                    ...
                    <div class="row">
                        ...
                        <div class="col col-xs-6 text-right">
                            <div class="pull-right">
                                <button class="btn btn-success" onclick="add_post()"><i class="glyphicon glyphicon-plus"></i> Add Post</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/post/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            ...
            url = "<?php echo site_url('admin/post/ajax_update') ?>";
        }
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="post_content" placeholder="Content" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                      <div class="form-group">
