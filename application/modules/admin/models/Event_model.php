...
class Event_model extends CI_model {
    ...
    var $table = 'events';
    var $column_order = array('event_id', 'event_title', 'event_date', 'event_desc', 'cat_id'); //set column field database for datatable orderable
    var $column_search = array('event_title'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    private function _get_datatables_query() {
        ...
        $this->db->join('categories', 'categories.category_id = events.cat_id');
        $i = 0;
