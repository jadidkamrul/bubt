...
class Category_model extends CI_model {
    ...
    var $column_order = array('category_id','cat_title'); //set column field database for datatable orderable
    var $column_search = array('cat_title'); //set column field database for datatable searchable just firstname , lastname , address are searchable
