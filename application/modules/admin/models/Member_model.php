...
class Member_model extends CI_model {
    ...
    var $table = 'faculty_member';
    var $column_order = array('member_name'); //set column field database for datatable orderable
    var $column_search = array('member_name'); //set column field database for datatable searchable just firstname , lastname , address are searchable
