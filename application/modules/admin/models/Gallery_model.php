...
class Gallery_model extends CI_model {
    ...
    var $table = 'gallery';
    var $column_order = array('img_text'); //set column field database for datatable orderable
    var $column_search = array('img_text'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    var $order = array('gallery_id' => 'desc'); // default order 
