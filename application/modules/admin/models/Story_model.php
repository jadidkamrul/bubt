...
class Story_model extends CI_model {
    ...
    var $table = 'success_story';
    var $column_order = array('video_link'); //set column field database for datatable orderable
    var $column_search = array('video_link'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    var $order = array('story_id' => 'desc'); // default order 
