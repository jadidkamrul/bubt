...
class Post_model extends CI_model {
    ...
    var $table = 'posts';
    var $column_order = array('post_title', 'image','post_date', 'post_content', 'post_status'); //set column field database for datatable orderable
    var $column_search = array('post_title', 'post_date', 'post_content'); //set column field database for datatable searchable just firstname , lastname , address are searchable
