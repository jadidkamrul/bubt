...
class Notice_model extends CI_model {
    ...
    var $table = 'notices';
    var $column_order = array('notice_id', 'notice_title', 'cat_id', 'notice_date');
    var $column_search = array('notice_title'); 
    var $order = array('notice_id' => 'desc'); 
    ...
    private function _get_datatables_query() {
        ...
        $this->db->join('categories', 'categories.category_id = notices.cat_id');
        $i = 0;
